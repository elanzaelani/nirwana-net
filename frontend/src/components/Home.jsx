...
const Home = () => {
  ...
  const getRowProduks = async () => {
    const response = await axios.get(API_URL+`produkRows`);
    setRowProduks(response.data.totalRows);
  };
  const getRowPelanggans = async () => {
    const response = await axios.get(API_URL+`pelangganRows`);
    setRowPelanggan(response.data.totalRows);
  };
  return (
    <div>
  ...
  <section className="content">
    <div className="container-fluid">
    <h3 className="subtitle">Hallo  <strong>{user && user.name}</strong></h3>
      ...
      <div className="row">
        ...
        <div className="col-lg-3 col-6">
          ...
          <div className="small-box bg-success">
            <div className="inner">
              <h3>{rowPelanggan}<sup style={{fontSize: 20}}> Orang</sup></h3>
              <p>Pelanggan</p>
            </div>
            <div className="icon">
